...
with open('data/fulldoc/fulldoc_cleaned.pickle', 'rb') as f:
    data = pickle.load(f)

with open('data/fulldoc/mapping.json') as f:
    mapping = json.load(f)
...
for i, doc in tqdm.tqdm(enumerate(data)):
    ...
    # ================================== FULL DOC ==================================
    arxiv_id, title, section = mapping[i]
    ...
    for entity_type, entity_name, confidence, *args in entities:
        ...
        graph_database.add_relation('Appear-in',
                                    entity, 
                                    paper_entity, 
                                    confidence,
