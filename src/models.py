...
# ENTITIY_CLASS = (Task, Method, Material, OtherScientificTerm, Metric, 
#                  Generic, Abbreviation, Paper)
...
class BaseEntity(neomodel.StructuredNode):
    ...
    part_of = neomodel.RelationshipTo(neomodel.StructuredNode, 'Part-of', model=PartOf)
    feature_of = neomodel.RelationshipTo(neomodel.StructuredNode, 'Feature-of', model=FeatureOf)
    compare = neomodel.RelationshipTo(neomodel.StructuredNode, 'Compare', model=Compare)
    hyponym_of = neomodel.RelationshipTo(neomodel.StructuredNode, 'Hyponym-of', model=HyponymOf)
    evaluate_for = neomodel.RelationshipTo(neomodel.StructuredNode, 'Evaluate-for', model=EvaluateFor)
